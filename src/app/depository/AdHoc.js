...
export class AdHoc extends Component {
    render() {
        return (
...
<div className="col-md-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Depository Ad-Hoc query builder</h4>
                <p className="card-description"> Please build Ad-Hoc query as needed! </p>
