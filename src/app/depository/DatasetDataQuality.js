...
export class DatasetDataQuality extends Component {
    render() {
        return (
...
<div className="col-md-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Dataset Data Quality</h4>
                <p className="card-description"> Please select dataset to view Quality info! </p>
...
export default DatasetDataQuality;