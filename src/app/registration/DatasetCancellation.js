...
export class DatasetCancellation extends Component {
    render() {
        return (
...
<div className="col-md-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Dataset Cancellation</h4>
                <p className="card-description"> Please provide dataset name and version to cancel the ! </p>
...
export default DatasetCancellation;