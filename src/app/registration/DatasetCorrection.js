...
export class DatasetCorrection extends Component {
    render() {
        return (
...
<div className="col-md-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Dataset Correction</h4>
                <p className="card-description"> Please update any of the field listed below! </p>
...
export default DatasetCorrection;