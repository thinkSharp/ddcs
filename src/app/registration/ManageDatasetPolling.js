...
export class ManageDatasetPolling extends Component {
    render() {
        return (
...
<div className="col-md-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Manage Dataset Polling</h4>
                <p className="card-description"> Please provide requested fields to get polling schedules! </p>
...
export default ManageDatasetPolling;