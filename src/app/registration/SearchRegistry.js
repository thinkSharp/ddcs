...
export class SearchRegistry extends Component {
    render() {
        return (
...
<div className="col-md-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Search Registry</h4>
                <p className="card-description"> Please provide requested fields to search registries! </p>
